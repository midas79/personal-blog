    ...
    <div>
        ...
        <div class="section-header">
            <?php if ($selectedCategory): ?>
                <h1 class="section-title"><?= esc($selectedCategory['name']) ?></h1>
                <p class="section-subtitle">
                    <?= $selectedCategory['description'] ? esc($selectedCategory['description']) : 'Posts in this category' ?>
                </p>
            <?php elseif ($search): ?>
                <h1 class="section-title">Search Results</h1>
                <p class="section-subtitle">Results for "<?= esc($search) ?>"</p>
            <?php else: ?>
        ...
        <form method="GET" action="<?= base_url('blog') ?>" class="search-form">
            ...
            <?php if ($search || $selectedCategory): ?>
                <a href="<?= base_url('blog') ?>" class="btn btn-outline">Clear</a>
            <?php endif; ?>
        </form>
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 64px 0;">
                ...
                <h4 style="color: var(--text-secondary); margin-bottom: 8px;">No posts found</h4>
                <?php if ($search): ?>
                    <p style="color: var(--text-muted); margin-bottom: 24px;">No posts match your search criteria.</p>
                    <a href="<?= base_url('blog') ?>" class="btn btn-primary">Back to All Posts</a>
                <?php else: ?>
                    <p style="color: var(--text-muted);">No posts available.</p>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
